...
import { 
  ...
  SiCplusplus, SiSharp, SiGo, SiRust 
} from 'react-icons/si';
...
export function LanguageBadge({ language, size = "md" }: Readonly<{ language: keyof typeof LANGUAGE_ICONS; size?: "sm" | "md" | "lg" }>) {
  ...
  return (
    <Icon className={cn(langInfo.color, sizeClasses[size])} />
  );
}
